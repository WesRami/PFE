...
public class IUserServiceImp implements IUserService {
  ...
  /* @Override
    ...
    @Override
    public Long countCollaborateur() {
        return userRepository.countCollaborateur();
    }

    @Override
    public List<UserMinDto> getActiveUsersSortedByBorrows() {
        return List.of();
    }

    @Override
    public List<ActiveUserDto> findActiveUsers() {
