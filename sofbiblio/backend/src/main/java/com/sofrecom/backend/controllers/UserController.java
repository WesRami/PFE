...
public class UserController {
    ...
    @Operation(summary = "LoginAdmin", description = "Login for Admins")
    ...
    @GetMapping("/countCollaborateur")
    public Long getCountCollaborateur() {
        return this.userService.countCollaborateur();
    }

    @GetMapping("/active")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<List<ActiveUserDto>> getActiveUsers() {
        List<ActiveUserDto> activeUsers = userService.findActiveUsers();
