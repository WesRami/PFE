class User {
  ...
  final int? loans; // Added: Number of borrowed
      ...
      return User(
        ...
        toReadBooks:
            json['toReadBooks'] != null
                ...
                : null,
        loans: json['loans'] as int? ?? 0, // Added: Handle loans field
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (loans != null) 'loans': loans, // Added: Include loans
    };
  }
  ...
  User copyWith({
    ...
    return User(
      ...
      loans: loans ?? this.loans, // Added: Include loans
    );
  }
}
