...
class AuthService {
  ...
  Future<List<User>> fetchActiveUsers() async {
    try {
      ...
      print('AuthService: Réponse fetchActiveUsers: ${response.statusCode}');
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Erreur lors de la récupération des utilisateurs actifs: ${response.statusCode} - ${response.body}',
        );
      }
    } catch (e) {
